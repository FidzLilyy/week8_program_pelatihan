...
$stmt = $pdo->prepare("SELECT * FROM peserta");
$stmt->execute();
...
<body>
    ...
    <a href="tools/tambah_peserta.php">Tambah Peserta</a>
    <table border="1">
        <tr>
            <th>ID</th>
            <th>Nama</th>
        ...
        <?php foreach ($peserta as $p): ?>
            <tr>
                ...
                <td><?= $p['telp'] ?></td>
                <td>
                    <a href="tools/edit_peserta.php?id=<?= $p['id'] ?>">Edit</a> |
                    <a href="tools/delete_peserta.php?id=<?= $p['id'] ?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
